    ...
    <div class="container">
      ...
      <div class="bg-faded p-4 my-4">
          ...
          <div class="carousel-inner" role="listbox">
            <div class="carousel-item active">
              ...
              <div class="carousel-caption d-none d-md-block">
                <h3 class="text-shadow">First Photo</h3>
                <p class="text-shadow">Lapangan Futsal</p>
              </div>
            </div>
            <div class="carousel-item">
              <img class="d-block img-fluid w-100" src="<?php echo base_url(); ?>/assets/img/slide-2.jpg" alt="">
              <div class="carousel-caption d-none d-md-block">
                <h3 class="text-shadow">Second Photo</h3>
                <p class="text-shadow">Lapangan Futsal</p>
              </div>
            </div>
            <div class="carousel-item">
              ...
              <div class="carousel-caption d-none d-md-block">
                <h3 class="text-shadow">Third Photo</h3>
                <p class="text-shadow">Lapangan Futsal</p>
              </div>
            </div>
          </div>
        ...
        <div class="text-center mt-4">
          <div class="text-heading text-muted text-lg">This is</div>
          <h1 class="my-2">Fifa Futsal</h1>
          <div class="text-heading text-muted text-lg">By
            <strong>Lapangan Futsal Terbaik</strong>
          </div>
        </div>
      </div>
      ...
      <div class="bg-faded p-4 my-4">
        <hr class="divider">
        <h2 class="text-center text-lg text-uppercase my-0">FIFA FUTSAL
          <strong>Lapangan Futsal Modern</strong>
        </h2>
        <hr class="divider">
      ...
      <div class="bg-faded p-4 my-4">
        <hr class="divider">
        <h2 class="text-center text-lg text-uppercase my-0">FIFA FUTSAL
          <strong>Lapangan Futsal Sintetis</strong>
        </h2>
        <hr class="divider">
        <!-- <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Magnam soluta dolore voluptatem, deleniti dignissimos excepturi veritatis cum hic sunt perferendis ipsum perspiciatis nam officiis sequi atque enim ut! Velit, consectetur.</p>
        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laboriosam pariatur perspiciatis reprehenderit illo et vitae iste provident debitis quos corporis saepe deserunt ad, officia, minima natus molestias assumenda nisi velit?</p> -->
